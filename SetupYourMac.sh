...
welcomeMessage="To begin, please click **Continue** to start applying settings to your new Mac.  \n\nOnce completed, your Mac will restart.  \n\nIf you need assistance, please contact Tech Support: +1 (844) 315-6682."
...
policy_array=('
{
	"steps": [
		...
		{
			"listitem": "Rosetta 2",
			"icon": "b34f07aef576e0612de041a0ee4d00bcebf4630aef229b1bc3e989ea9c798f5f",
			"progresstext": "Rosetta 2 allows Apple processors to run Intel code through dynamic recompilation.",
			"trigger_list": [
				{
					"trigger": "rosetta",
					"path": ""
		...
		},
		{
			...
			"icon": "e083be8a56b1d7a53e33a055076129098948f4d0cd6032501127115487a5ed9d",
			"progresstext": "Microsoft Outlook is a personal information manager software system.",
			"trigger_list": [
				{
					"trigger": "microsoftOutlook",
		...
		},
		{
			...
			"icon": "30f3c8072e62eee8218c2c6c74abfa17549314e3ae9cc6aac73c340973c8984d",
		...
		{
			"listitem": "Zoom",
			"icon": "ee3e2d6bb4ae319527eacb061eca9c91139eb686eed529c9369fa84e2a31ea03",
        ...
        {
			"listitem": "Rename Computer",
			"icon": "f0fbe6bdb065632594487092b97b11e1fa804b5e5a18276d397263383a61b602",
			"progresstext": "Renaming your computer for inventory purposes...",
			"trigger_list": [
				{
					"trigger": "renameComputer",
					"path": ""
				}
			]
		},
		...
		},
		{
			...
			"icon": "7e345122654213f06dd9e44ee8bdae4af9b70805fbc166ed56d61df500040d35",
...
for (( i=0; i<dialog_step_length; i++ )); do
	...
	if [[ -f "$path" ]] || [[ -z "$path" ]]; then
		...
		if [[ "$trigger" == "recon" ]] || [[ "$trigger" == "renameComputer" ]]; then
